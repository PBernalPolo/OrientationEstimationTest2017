...
MEKFcMRP::MEKFcMRP(const MEKFcMRP& orig) {
}
...
// inputs:
// outputs:
//  OrientationEstimator*: an OrientationEstimator pointer, pointing to the MEKFcMRP object
OrientationEstimator* MEKFcMRP::copy(){
  return new MEKFcMRP( *this );
}
...
void MEKFcMRP::fC2M( double* e , double* delta ){
...
void MEKFcMRP::chartUpdateMatrix( double* delta , double* G ){
  for(int i=0; i<3; i++){

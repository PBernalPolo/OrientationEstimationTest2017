...
MEKFcRV::MEKFcRV(const MEKFcRV& orig) {
}
...
// inputs:
// outputs:
//  OrientationEstimator*: an OrientationEstimator pointer, pointing to the MEKFcRV object
OrientationEstimator* MEKFcRV::copy(){
  return new MEKFcRV( *this );
}
...
void MEKFcRV::fC2M( double* e , double* delta ){
...
void MEKFcRV::chartUpdateMatrix( double* delta , double* G ){

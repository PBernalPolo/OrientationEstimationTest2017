...
MEKFcRP::MEKFcRP(const MEKFcRP& orig) {
}
...
// inputs:
// outputs:
//  OrientationEstimator*: an OrientationEstimator pointer, pointing to the MEKFcRP object
OrientationEstimator* MEKFcRP::copy(){
  return new MEKFcRP( *this );
}
...
void MEKFcRP::fC2M( double* e , double* delta ){
...
void MEKFcRP::chartUpdateMatrix( double* delta , double* G ){

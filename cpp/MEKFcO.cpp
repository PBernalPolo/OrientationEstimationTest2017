...
MEKFcO::MEKFcO(const MEKFcO& orig) {
}
...
// inputs:
// outputs:
//  OrientationEstimator*: an OrientationEstimator pointer, pointing to the MEKFcO object
OrientationEstimator* MEKFcO::copy(){
  return new MEKFcO( *this );
}
...
void MEKFcO::fC2M( double* e , double* delta ){
...
void MEKFcO::chartUpdateMatrix( double* delta , double* G ){
